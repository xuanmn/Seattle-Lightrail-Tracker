...
👉 **[Open Live Tracker](https://xuanmn.github.io/Seattle-Lightrail-Tracker/)**
...
- [OneBusAway Puget Sound](https://onebusaway.org/) — Real-time arrival predictions and vehicle tracking API.
- [Sound Transit](https://www.soundtransit.org/) — Link Light Rail schedule data and transit feeds.
- [Transit Tracker API](https://github.com/tjhorner/transit-tracker-api) — Inspiration for departure board concepts.
